...
public:
    ...
    SingleLinkedList(Iterator begin, Iterator end) {
        ...
        Node** last_element_temp = &temp.head_.next_node;
        while (begin != end)
        {
            *last_element_temp = new Node(*begin, nullptr);
            last_element_temp = &(*last_element_temp)->next_node;
            ++temp.size_;
            ++begin;
        }
        swap(temp);
    ...
    void PopFront() noexcept {
        ...
        Node* note_to_delete = head_.next_node;
        head_.next_node = note_to_delete->next_node;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        assert(pos.node_);
        Node* note_to_delete = pos.node_->next_node;
        pos.node_->next_node = note_to_delete->next_node;
        delete note_to_delete;
